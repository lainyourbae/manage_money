    ...
    <div class="flex">
        <div id="Main" class="xl:rounded-r transform  xl:translate-x-0  ease-in-out transition duration-1000 flex justify-between items-start h-screen  w-1/5 bg-green-900 flex-col text-gray-100 sticky top-0">
            <div class="flex flex-col justify-start items-center w-full ">
                ...
                <a href="saya_Transaksi.php" class="flex jusitfy-start items-center w-full py-3 pl-12 space-x-8 focus:outline-none text-gray-200 rounded-xl bg-green-950 duration-200">
        ...
        <div class="text-lg mx-auto w-3/5">
            ...
            <form method="GET" id="form-filter" style="display: none;"> 
                ...
                <div class="Tambah_Transaksi-field" class="">
            ...
            <a href="form_Tambah_Transaksi.php" class="text-2xl rounded-xl px-3 bg-green-700 hover:bg-green-600">Tambah Transaksi</a>

    <div id="tabel-container" class="mt-10">
        <?php
            ...
            echo "<table class='table-auto text-left text-md'>
                <tr>
                <th class='px-4 py-3 bg-green-700'>Dompet</th>
                <th class='px-4 py-3 bg-green-700'>Tanggal Transaksi</th>
                <th class='px-4 py-3 bg-green-700'>Jumlah Transaksi</th>
                <th class='px-4 py-3 bg-green-700'>Jenis Transaksi</th>
                <th class='px-4 py-3 bg-green-700'>Kategori Transaksi</th>
                <th class='px-4 py-3 bg-green-700'>Catatan Transaksi</th>
                <th class='px-4 py-3 bg-green-700'>Tindakan</th>
                </tr>";
            ...
            while ($row = pg_fetch_assoc($result)) {
                ...
                echo "<tr class='bg-green-50 border-b'>
                        <td class='px-4 py-3'>" . $row['nama_dompet'] . "</td>
                        <td class='px-4 py-3'>" . $row['tanggal_transaksi'] . "</td>
                        <td class='px-4 py-3'>" . $row['jumlah_transaksi'] . "</td>
                        <td class='px-4 py-3'>" . $row['jenis_transaksi'] . "</td>
                        <td class='px-4 py-3'>" . $tipe['nama_tipe'] . "</td>
                        <td class='px-4 py-3'>" . $row['catatan_transaksi'] . "</td>
                        <td class='px-4 py-3'>
                        <a href='proses_Hapus_Transaksi.php?id_transaksi=".$row['id_transaksi']."' class='px-1 h-12 rounded-md border-green-700 border-2  bg-green-50 hover:bg-green-700'>Hapus</a><a class='text-green-50'>|</a>
                        <a href='form_Edit_Transaksi.php?id_transaksi=".$row['id_transaksi']."'class='px-1 h-12 rounded-md border-green-700 border-2 bg-green-50 hover:bg-green-700'>Edit</a>
                        </td>
                    </tr>";
            }
