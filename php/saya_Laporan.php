        ...
        <div id="Main" class="xl:rounded-r transform  xl:translate-x-0  ease-in-out transition duration-1000 flex justify-between items-start h-screen  w-1/5 bg-green-900 flex-col text-gray-100 sticky top-0">
            ...
            <?php
                ...
                if (($dompetRow) && ($bulanRow = pg_fetch_assoc($resultbulan))) {
                    ...
                    $bulan_final = "$tahun-$bulan";
                    echo '<a href="saya_laporan.php?id_dompet=' . $idDompet . '&bulan=' . $bulan_final . '"class="flex jusitfy-start items-center w-full py-3 pl-12 space-x-8 focus:outline-none text-gray-200 rounded-xl bg-green-950 duration-200">
        ...
        <div class="text-lg mx-auto w-3/5">
            ...
            <div class="mx-auto">
                ...
                <div>Filter:</div>
                    ...
                    <button class="bg-green-50 mb-10 hover:bg-green-800 p-1 px-2 rounded-2xl text-green-800 hover:text-green-50 shadow-lg border-2 border-green-800" name="submit" type="submit">Show</button>
                </form>
            </div>

  <div id="tabel-container">
        <table class='w-full table-auto text-left text-md'>
    ...
    <?php
        ...
        while ($row = pg_fetch_assoc($result)) {
            ...
            echo "<tr class='bg-green-50 border-b'>
                    ...
                    <td class='px-4 py-3'>" . $row['total_pemasukan'] . "</td>
                    <td class='px-4 py-3'>" . $row['total_pengeluaran'] . "</td>
