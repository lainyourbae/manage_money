        ...
        <div class="flex">
            <div id="Main" class="xl:rounded-r transform  xl:translate-x-0  ease-in-out transition duration-1000 flex justify-between items-start h-screen  w-1/5 bg-green-900 flex-col text-gray-100 sticky top-0">
                <div class="flex flex-col justify-start items-center w-full ">
                    ...
                    <a href="saya_Dompet.php" class="flex jusitfy-start items-center w-full py-3 pl-12 space-x-8 focus:outline-none text-gray-200 rounded-xl bg-green-950 duration-200">
            ...
            <div class="text-3xl mx-auto w-3/5">
                ...
                <?php
                    ...
                    while($counter < $cek){
                        if ($cek > 0) {
                            ...
                            echo "<div class='text-green-50 mt-10 h-32 rounded-2xl mx-auto w-2/3 bg-green-800 flex justify-between px-10 py-7 shadow-lg'>";
                            echo     "<div class='flex'>";
                            echo          '<svg class="w-12 h-12 mt-3 mr-4 fill-green-50" viewBox="0 0 23.46 19.02" xmlns="http://www.w3.org/2000/svg">
                            <title/><g data-name="Camada 2" id="Camada_2"><g data-name="Camada 1" id="Camada_1-2">
                            <path d="M22.17,7.53V2a2,2,0,0,0-2-2H2A2,2,0,0,0,0,2V17.05a2,2,0,0,0,2,2H20.2a2,2,0,0,0,2-2V13.51a1.41,1.41,0,0,0,1.29-1.4V8.94A1.41,1.41,0,0,0,22.17,7.53ZM2,1H20.2a1,1,0,0,1,1,1v.32a1.94,1.94,0,0,0-1-.27H2a1.94,1.94,0,0,0-1,.27V2A1,1,0,0,1,2,1ZM20.2,18H2a1,1,0,0,1-1-1V4A1,1,0,0,1,2,3H20.2a1,1,0,0,1,1,1V7.52H16.46a3,3,0,0,0,0,6h4.71v3.53A1,1,0,0,1,20.2,18Zm2.26-5.92a.42.42,0,0,1-.42.42H16.46a2,2,0,0,1,0-4H22a.42.42,0,0,1,.42.42Z"/><circle cx="16.5" cy="10.42" r="0.82"/></g></g>
                            </svg>';
                            echo          "<div>";
                            echo            "<div class='text-lg'>nama</div>";
                            echo            "<div class='font-semibold'>".$_SESSION["nama_dompet"]."</div>";
                            echo          "</div>";
                            echo    "</div>";
                            echo    "<div>";
                            echo        "<div class='text-lg'>saldo</div>";
                            echo        "<div class='font-semibold'>Rp ".$_SESSION["saldo"]."</div>";
                            echo    "</div>";
                            echo "</div>";
                            ...
                            echo "<div class='mt-1 mx-auto w-2/3 flex justify-between'>";
                            echo     "<div></div>";
                            echo     "<div>";
                            echo         "<a href='proses_Hapus_Dompet.php?id_dompet=".$_SESSION['id_dompet']."' class='text-green-50 text-2xl px-1 pl-3 h-12 rounded-bl-xl rounded-tl-xl bg-green-800 hover:bg-green-900 border-r-2 border-green-900'>Hapus</a>";
                            echo         "<a href='form_Edit_Dompet.php?id_dompet=".$_SESSION['id_dompet']."' class='text-green-50 text-2xl px-1 pr-3 h-12 rounded-br-xl rounded-tr-xl bg-green-800 hover:bg-green-900'>Edit</a>";
                            echo     "</div>";
                            echo "</div>";
                ...
                ?>
                <div class='text-green-50 mt-10 h-10 rounded-full w-10 bg-green-800 text-center shadow-lg mx-auto'>
                        <a href="form_Tambah_Dompet.php" class="text-4xl">+</a>
                    </div>
                ...
                <thead>
                    <tr>
                        <th class="border-b-2 border-green-800">Saldo Total</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                ...
                <p class='mt-5'><a href="form_Tambah_Transaksi.php" class="text-green-50 text-2xl rounded-xl px-3 bg-green-800 hover:bg-green-900">Tambah Transaksi</a></p>
                <br>
            </div>
