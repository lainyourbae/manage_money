            ...
            <div class='text-2xl mx-auto w-3/5'>
                <div class="grid h-screen place-items-center">
                    <div class="bg-green-800 p-20 w-4/5 h-5/6 rounded-3xl drop-shadow-2xl text-green-50">
                        <h1 class="text-center text-5xl mb-10">Edit Transaksi</h1>
                        <form class="mx-7 flex flex-col" method="post" action="proses_Edit_Transaksi.php?id_transaksi=<?php echo $transaksi['id_transaksi'];?>">

                <div class="Edit_Transaksi-field">
                    <label for="jumlah_transaksi">Jumlah: </label>
                    <input class="mt-5 px-2 text-black text-2xl 48 rounded-lg bg-gray-100 border-gray-300 border-2 focus:outline-none" type="text" value="<?php echo $transaksi['jumlah_transaksi'];?>" name="jumlah_transaksi" autofocus required pattern="([1-9])[0-9]{2,20}">
                </div>
                ...
                <select id="pilihan_pengeluaran" value="<?php echo $transaksi['kategori_transaksi'];?>" name="pilihan_pengeluaran" style="display: none; color: black;" class="rounded-xl m-2" required>
                ...
                <select id="pilihan_pemasukan" value="<?php echo $transaksi['kategori_transaksi'];?>" name="pilihan_pemasukan" style="display: none; color: black;" class="rounded-xl m-2" required>
                    <option disabled selected value="holder">Kategori Transaksi: </option>
                    <?php
                ...
                <div class="Edit_Transaksi-field">
                    ...
                    <input class="text-black" type="date" name="tanggal_transaksi" value="<?php echo $transaksi['tanggal_transaksi'];?>"required>
                </div>

                <div class="Edit_Transaksi-field">
                    <label for="catatan_transaksi">Catatan: </label>
                    <textarea class="text-black mt-5 px-2 text-2xl rounded-lg bg-gray-100 border-gray-300 border-2 focus:outline-none" name="catatan_transaksi"><?php echo $transaksi['catatan_transaksi'];?></textarea>
                </div>
                ...
                <input class="px-7 mt-10 py-3 hover:cursor-pointer text-3xl rounded-2xl self-center shadow-lg hover:bg-green-100 bg-green-50 text-black" type="submit" value="Simpan" name="submit">
            </form>
                    </div>
                </div>
