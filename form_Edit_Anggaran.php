        ...
        <div class="flex">
            ...
            <div class='text-3xl mx-auto w-3/5'>
                <div class="grid h-screen place-items-center">
                    <div class="bg-green-800 p-20 w-3/5 h-1/2 rounded-3xl drop-shadow-2xl text-green-50">
                        <h1 class="text-center text-5xl mb-10">Edit Anggaran</h1>
                        <form class="mx-7 flex flex-col items-center" method="post" action="proses_Edit_Anggaran.php">
                            ...
                            <div class="Tambah_Anggaran-field">
                                <div>Saldo</div>
                                <input  class="px-2 text-2xl text-black rounded-lg bg-gray-100 border-gray-300 border-2 focus:outline-none" type="money" name="nominal_anggaran" value="<?php echo $anggaran['nominal_anggaran']?>" required pattern="[0-9\s]{3,20}">
                            </div>
