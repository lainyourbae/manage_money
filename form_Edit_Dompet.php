    ...
    <div class="flex">
            ...
            <div class='text-3xl mx-auto w-3/5'>
                <div class="grid h-screen place-items-center">
                    <div class="bg-green-800 p-20 w-3/5 h-3/5 rounded-3xl drop-shadow-2xl text-green-50">
                        <h1 class="text-center text-5xl mb-10">Edit Dompet</h1>
                        <form class="mx-7 flex flex-col items-center" method="post" action="proses_Edit_Dompet.php?id_dompet=<?php echo $dompet['id_dompet'];?>">

                            <div class="Edit_Dompet-field">
                                <div>Nama Dompet</div>
                                <input class="px-2 text-2xl text-black rounded-lg bg-gray-100 border-gray-300 border-2 focus:outline-none" type="text" value="<?php echo $dompet['nama_dompet'];?>" name="nama_dompet" autofocus required pattern="([A-Z])[A-Z/a-z\s]{1,128}">
                            </div>

                            <div class="Edit_Dompet-field">
                                <div class="mt-5">Saldo</div>
                                <input class="px-2 text-2xl text-black rounded-lg bg-gray-100 border-gray-300 border-2 focus:outline-none" type="text" value="<?php echo $dompet['saldo'];?>" name="saldo" required pattern="[0-9\s]{3,20}">
                            </div>

                            <input class="px-7 mt-10 py-3 hover:cursor-pointer bg-green-100 text-3xl rounded-2xl shadow-lg hover:bg-green-200 text-black" type="submit" value="Simpan" name="submit">
