        ...
        <div class="flex">
            <div id="Main" class="xl:rounded-r transform  xl:translate-x-0  ease-in-out transition duration-1000 flex justify-between items-start h-screen  w-1/5 bg-green-900 flex-col text-gray-100 sticky top-0">
                <div class="flex flex-col justify-start items-center w-full ">
                    ...
                    <a href="saya_Profil.php" class="flex jusitfy-start items-center w-full py-3 pl-12 space-x-8 focus:outline-none text-gray-200 rounded-xl bg-green-950 duration-200">
            ...
            <div class="text-3xl mx-auto w-3/5">
                <div class="mt-10 text-center">
                    ...
                    <div class="h-16"></div>
                    <svg class="w-16 h-16 fill-gray-200 mx-auto" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 11C14.2091 11 16 9.20914 16 7C16 4.79086 14.2091 3 12 3C9.79086 3 8 4.79086 8 7C8 9.20914 9.79086 11 12 11Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M6 21V19C6 17.9391 6.42143 16.9217 7.17157 16.1716C7.92172 15.4214 8.93913 15 10 15H14C15.0609 15 16.0783 15.4214 16.8284 16.1716C17.5786 16.9217 18 17.9391 18 19V21" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                    ...
                    <?php
                        ...
                        while($counter < $cek){
                            if ($cek > 0) {
                                ...
                                echo "<div class='mt-2'>".$_SESSION["nama_pengguna"]."</div>";
                                echo "<div class='mt-2'>".$_SESSION["email"]."</div>";
                ...
                <div class="dompet">  
                    <div class="mt-10 font-semibold border-b-2 border-green-800">Data Dompet</div>
                    ...
                    ?>
                    <div class='mt-10 h-10 rounded-full w-10 bg-green-800 text-center shadow-lg mx-auto'>
                        <a href="form_Tambah_Dompet.php" class="text-4xl text-green-50">+</a>
                    </div>
